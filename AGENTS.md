...
assuming they are highly capable and malicious. Using the `runsc` runtime (i.e. gVisor)
and disabling external networking access are fundamental to this strategy and should not
be changed.
...
In docstrings describe the behavior of the interface. Prefer to skip discussions on how it
is implemented in the docstring. If helpful add comments that describe the implementation
as code comments.
