...
if __name__ == "__main__":
    # Self-test: verifies the properties this module claims. The persistence
    # and long-running-command checks are the point - they're what distinguish
    # this from a `docker exec` per command.
